...
const triggerClassName = (variant: PermissionApprovalModeSelectorProps['variant']): string => cn(
  ...
  'active:scale-[0.97]',
  variant === 'default'
    ? 'border-slate-200/75 bg-white/45 text-slate-500 hover:border-slate-300 hover:bg-white/75 hover:text-slate-800 dark:border-(--app-border-subtle) dark:bg-(--app-surface) dark:text-(--app-text-secondary) dark:hover:border-(--app-border-standard) dark:hover:bg-(--app-surface-hover) dark:hover:text-(--app-text-primary)'
    : variant === 'surface'
      ...
      : 'border-border/30 bg-background/35 text-muted-foreground hover:border-border/55 hover:bg-foreground/[0.04] hover:text-foreground dark:border-(--app-border-subtle) dark:bg-(--app-surface) dark:text-(--app-text-secondary) dark:hover:border-(--app-border-standard) dark:hover:bg-(--app-surface-hover) dark:hover:text-(--app-text-primary) dark:data-[state=open]:border-(--app-border-standard) dark:data-[state=open]:bg-(--app-surface-hover) dark:data-[state=open]:text-(--app-text-primary)'
)
          ...
          <DropdownMenu open={open} onOpenChange={setOpen}>
            ...
            <DropdownMenuContent
              ...
              className={cn(
                ...
                'dark:border-(--app-border-standard) dark:bg-(--app-surface-raised) dark:text-(--app-text-primary) dark:shadow-black/30 dark:backdrop-blur-none'
              )}
            >
              <DropdownMenuLabel className="px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground/75 dark:text-(--app-text-muted)">
                Approval mode
              </DropdownMenuLabel>
                  ...
                  return (
                    <DropdownMenuPrimitive.RadioItem
                      ...
                      className={cn(
                        ...
                        'dark:text-(--app-text-body) dark:focus:border-(--app-border-standard) dark:focus:bg-(--app-surface-hover) dark:focus:text-(--app-text-primary)',
                        'dark:data-[state=checked]:border-(--app-border-standard) dark:data-[state=checked]:bg-(--app-surface-hover) dark:data-[state=checked]:text-(--app-text-primary)'
                      )}
                    >
                      ...
                      <span
                        className={cn(
                          ...
                          mode === value
                            ? 'border-border/60 bg-background/85 opacity-100 dark:border-(--app-border-standard) dark:bg-(--app-surface) dark:text-(--app-accent-strong) dark:shadow-none'
