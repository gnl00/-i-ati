...
export interface FluidTypewriterTextLayout {
  visible: string[]
...
export function buildFluidTypewriterTextLayout(args: {
  tokens: string[]
  visibleTokens?: string[]
  visibleCount?: number
  animationWindow: number
  liveTokenLimit?: number
}): FluidTypewriterTextLayout {
...
export const FluidTypewriterText = ({
  ...
  const layout = useMemo(() => {
    const t0 = performance.now()
    const built = buildFluidTypewriterTextLayout({
