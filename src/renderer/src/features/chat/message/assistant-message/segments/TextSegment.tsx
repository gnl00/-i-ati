...
export const TextSegment: React.FC<TextSegmentProps> = memo(({
  ...
  return (
    <ReactMarkdown
      ...
      className={cn(
        'chat-assistant-prose prose px-2 text-sm text-blue-gray-600 dark:prose-invert prose-hr:mt-2 prose-hr:mb-1 prose-p:mb-2 prose-p:mt-2 prose-code:text-blue-400 dark:prose-code:text-(--chat-accent) font-normal max-w-full',
