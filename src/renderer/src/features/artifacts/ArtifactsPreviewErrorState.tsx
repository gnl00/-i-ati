...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@renderer/shared/components/ui/accordion'
    ...
    >
      <div className="flex-1 overflow-auto bg-white p-4 dark:bg-gray-900 md:p-5">
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-4 animate-in fade-in slide-in-from-bottom-2 duration-300 motion-reduce:animate-none">
          <section className="rounded-xl border border-red-200/70 bg-red-50/60 p-4 dark:border-red-900/50 dark:bg-red-950/20">
          ...
          <section className="overflow-hidden rounded-xl border border-black/[0.07] bg-white shadow-xs dark:border-white/8 dark:bg-zinc-950">
            <div className="border-b border-black/6 bg-zinc-50 px-3 py-2 dark:border-white/8 dark:bg-zinc-900/70">
              <div className="flex items-center justify-between gap-3">
                ...
                <Button
                  ...
                  className="h-7 rounded-lg border-zinc-200 bg-white/80 px-2.5 text-[11px] font-medium text-zinc-700 transition-colors hover:bg-zinc-50 active:scale-[0.98] dark:border-zinc-800 dark:bg-zinc-950/70 dark:text-zinc-200 dark:hover:bg-zinc-900"
                >
                  <Copy className="mr-1.5 h-3 w-3 opacity-80 text-zinc-500 dark:text-zinc-400" />
                  Copy Details
                </Button>
              </div>
            </div>
            ...
            <div className="px-3 py-3">
              <div className="mb-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-zinc-400 dark:text-zinc-500">
                Error message
              </div>
              <pre className="max-h-40 overflow-auto whitespace-pre-wrap wrap-break-word rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 font-mono text-xs leading-5 text-zinc-800 dark:border-zinc-800 dark:bg-zinc-900/70 dark:text-zinc-200">{error || 'No error message available'}</pre>
            </div>
            ...
            {logs.length > 0 && (
              ...
              >
                <AccordionItem value="logs" className="border-0">
                  ...
                  <AccordionContent className="border-t border-black/6 bg-zinc-950 p-0 dark:border-white/8">
