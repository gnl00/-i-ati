...
} from '@renderer/components/chat/chatMessage/assistant-message/AssistantMessageLayout'
import { AssistantMessage } from '@renderer/components/chat/chatMessage/assistant-message'
import type {
        ...
        buildToolCallItem({
          ...
          args: {
            files: [
              ...
              'model-badge/ModelBadgeNext.tsx'
            ],
            scope: 'renderer'
          },
    ...
    model: buildAssistantModel({
      ...
      supportItems: [
        buildToolCallItem({
          ...
          args: {
            path: 'src/renderer/src/components/chat/chatMessage/assistant-message/MissingReason.tsx'
          },
          status: 'error',
          cost: 188,
          result: {
...
const sequentialToolSpecs: SequentialToolSpec[] = [
  ...
  },
  {
    ...
    args: {
      path: 'src/renderer/src/components/chat/chatMessage/assistant-message/model/toolCallReason.ts'
    },
    cost: 760,
    result: {
      lines: 118,
    ...
    segments: [
      buildContainerToolCallSegment({
        ...
        args: {
          ...
          path: 'src/renderer/src/components/chat/chatMessage/assistant-message'
        },
        result: {
          matches: 2
        }
      ...
      buildContainerToolCallSegment({
        ...
        index: 1,
        args: {
          path: 'src/renderer/src/components/chat/chatMessage/assistant-message/AssistantMessageContainer.tsx'
        }
      }),
      {
        type: 'text',
