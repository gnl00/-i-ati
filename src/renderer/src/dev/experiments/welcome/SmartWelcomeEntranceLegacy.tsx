...
import { useAssistantStore } from '@renderer/features/assistants/assistantStore'
import { pickEmotionEmoji } from '@shared/emotion/emotionAssetCatalog'
import {
  getMsUntilNextSmartGreetingRefresh,
  pickSmartGreeting,
  type TimeOfDay
} from '@renderer/features/chat/welcome/smartGreeting'
import { useWelcomeEmotionState, WELCOME_EMOTION_FALLBACK } from '@renderer/features/chat/welcome/useWelcomeEmotionState'
