import { TaskPlanBar } from '@renderer/features/chat'
      ...
      <div className="relative mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-10">
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-400">
            This page is a dormant renderer-only test surface. Tune density, status weight, and sticky-top fit here while the production `App.tsx` continues to render `Home`.
          </p>
        </div>
