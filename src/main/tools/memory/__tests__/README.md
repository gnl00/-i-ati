...
- **位置**: `src/main/tools/memory/__tests__/MemoryToolsProcessor.test.ts`
- **测试框架**: Vitest
- **测试数量**: 9 个测试用例
...
```
✓ src/main/tools/memory/__tests__/MemoryToolsProcessor.test.ts (9)
...
- [Memory Tools 定义](../../../../shared/tools/memory/definitions.ts)
