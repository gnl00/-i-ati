...
import { PluginCapabilityRepository } from './repositories/PluginCapabilityRepository'
import { PluginSettingRepository } from './repositories/PluginSettingRepository'
import { ProviderRepository } from './repositories/ProviderRepository'
import { ChatRepository } from './repositories/ChatRepository'
import { ChatHostBindingRepository } from './repositories/ChatHostBindingRepository'
import { ChatSkillRepository } from './repositories/ChatSkillRepository'
...
import { ScheduledTaskRepository, ScheduledTaskRow } from './repositories/ScheduledTaskRepository'
...
import { TaskPlanDataService } from './dataServices/TaskPlanDataService'
import { ScheduledTaskDataService } from './dataServices/ScheduledTaskDataService'
import { ChatDataService } from './dataServices/ChatDataService'
import { ChatHostBindingDataService } from './dataServices/ChatHostBindingDataService'
import { MessageDataService } from './dataServices/MessageDataService'
import { EmotionStateDataService } from './dataServices/EmotionStateDataService'
import { WorkContextDataService } from './dataServices/WorkContextDataService'
import { ConfigDataService } from './dataServices/ConfigDataService'
import { McpServerDataService } from './dataServices/McpServerDataService'
import { PluginDataService } from './dataServices/PluginDataService'
import { CompressedSummaryDataService } from './dataServices/CompressedSummaryDataService'
import { RunEventDataService } from './dataServices/RunEventDataService'
import { AssistantDataService } from './dataServices/AssistantDataService'
import { LocalPluginCatalogService, LocalPluginInstallService, RemotePluginInstallService, RemotePluginRegistryService } from '../services/plugins'
...
class DatabaseService {
  ...
  private runEventDataService?: RunEventDataService
  ...
  public async initialize(): Promise<void> {
    ...
    try {
      ...
      this.runEventRepo = new RunEventRepository(this.db)
      ...
      this.runEventDataService = new RunEventDataService({
        hasDb: () => Boolean(this.db),
      ...
      // 初始化内置 Assistants
      const { initializeBuiltInAssistants } = await import('../bootstrap/AssistantBootstrap')
  ...
  public getWorkContextByChatId(chatId: number): import('./dataServices/WorkContextDataService').WorkContextRecord | undefined {
  ...
  public getWorkContextByChatUuid(chatUuid: string): import('./dataServices/WorkContextDataService').WorkContextRecord | undefined {
    if (!this.workContextDataService) throw new Error('Work context data service not initialized')
    return this.workContextDataService.getWorkContextByChatUuid(chatUuid)
  }

  public upsertWorkContext(chatId: number, chatUuid: string, content: string): import('./dataServices/WorkContextDataService').WorkContextRecord {
    if (!this.workContextDataService) throw new Error('Work context data service not initialized')
  ...
  public close(): void {
    if (this.db) {
      ...
      this.runEventDataService = undefined
  ...
  public saveRunEvent(data: RunEventTrace): number {
    if (!this.runEventDataService) throw new Error('Run event data service not initialized')
    return this.runEventDataService.saveRunEvent(data)
  }
