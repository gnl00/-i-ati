import type { EmotionStateRepository } from '@main/db/repositories/EmotionStateRepository'

type EmotionStateDataServiceDeps = {
  hasDb: () => boolean
  getEmotionStateRepo: () => EmotionStateRepository | undefined
}

export class EmotionStateDataService {
  constructor(private readonly deps: EmotionStateDataServiceDeps) {}
  ...
  private requireRepo(): EmotionStateRepository {
