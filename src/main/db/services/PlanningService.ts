...
import type { ScheduledExecutionChatBinding, ScheduledTaskRepository } from '../repositories/ScheduledTaskRepository'
...
export class PlanningService {
  ...
  getScheduledTaskRunAttempts(runId: string, limit?: number): ScheduledTaskRunAttemptRow[] { return this.requireScheduledTaskRepository().listRunAttempts(runId, limit) }
  ...
  createExecutionChatAndBindAttempt(runId: string, attempt: number, submissionId: string, chat: ChatEntity, now: number): ScheduledExecutionChatBinding {
    return this.requireScheduledTaskRepository().createExecutionChatAndBindAttempt(runId, attempt, submissionId, chat, now)
  }
