...
import { DefaultNextAgentRuntime } from '../NextAgentRuntime'
...
import type { AgentRequestSpecSource, LoopRunDescriptorSource } from '../NextAgentRuntimeContext'
...
describe('DefaultNextAgentRuntime', () => {
  it('completes a single-step text response', async () => {
    ...
    expect(result.finalStep.content).toBe('Hello from next')
