import type { LoopInputBootstrapper, LoopInputBootstrapperInput } from '@main/services/next/host/bootstrap/LoopInputBootstrapper'
import type { AgentLoopInput } from '@main/services/next/loop/AgentLoopInput'
...
} from '@main/services/next/transcript/AgentTranscriptRecord'
  ...
  bootstrap(input: LoopInputBootstrapperInput): AgentLoopInput {
    ...
    for (const message of initialMessages) {
      ...
      if (message.role === 'assistant') {
        currentAssistantStepId = input.runtimeInfrastructure.loopIdentityProvider.nextStepId()
