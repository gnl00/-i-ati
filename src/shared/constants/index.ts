...
export const GET_WIN_POSITION = 'get-win-position'
export const SET_WIN_POSITION = 'set-position'
export const IPC_PING = 'ping'
export const HTTP_REQUEST = 'http-request'
export const SELECT_DIRECTORY = 'select-directory'
export const CHECK_IS_DIRECTORY = 'check-is-directory'
...
export const SKILL_INSTALL_ACTION = 'skill:install'
...
export const SKILL_REVEAL_ACTION = 'skill:reveal-in-folder'
...
export const MEMORY_GET_ALL = 'memory-get-all'
...
export const DB_CHAT_SEARCH = 'db:chat:search'
...
export const DB_MESSAGE_PATCH_UI_STATE = 'db:message:patch-ui-state'
...
export const TELEGRAM_GATEWAY_STATUS = 'telegram:gateway:status'
export const TELEGRAM_GATEWAY_TEST = 'telegram:gateway:test'
export const TELEGRAM_GATEWAY_START = 'telegram:gateway:start'
export const TELEGRAM_GATEWAY_STOP = 'telegram:gateway:stop'
export const EMOTION_PACKS_GET = 'emotion:packs:get'
export const DB_EMOTION_STATE_GET_LATEST = 'db:emotion-state:get-latest'
export const DB_PLUGINS_GET = 'db:plugins:get'
export const DB_PLUGINS_REMOTE_LIST = 'db:plugins:remote:list'
export const DB_PLUGINS_REMOTE_INSTALL = 'db:plugins:remote:install'
export const DB_PLUGINS_SAVE = 'db:plugins:save'
export const DB_PLUGINS_RESCAN = 'db:plugins:rescan'
export const DB_PLUGINS_IMPORT = 'db:plugins:import'
export const DB_PLUGINS_UNINSTALL = 'db:plugins:uninstall'
...
export const DB_SCHEDULED_TASKS_LIST = 'db:scheduled-tasks:list'
...
export const RUN_PERMISSION_APPROVAL_MODE_UPDATE = 'run:permission-approval-mode:update'
