...
- `docs/spec/tools/computer-use-probe-scenarios.example.json`
...
```bash
pnpm run native:kwwk:build
pnpm run computer-use:probe -- --scenarios docs/spec/tools/computer-use-probe-scenarios.example.json
```

When permissions need to be requested from the terminal/helper identity:

```bash
pnpm run computer-use:probe -- --request-permissions --scenarios docs/spec/tools/computer-use-probe-scenarios.example.json
```
