...
Owner: Knowledgebase maintainers<br>
Status: Active<br>
Started: 2026-07-11<br>
Target: Resolve recall relevance findings and define acceptance thresholds<br>
Exit criteria: Findings are verified, accepted changes are tested, and durable behavior is documented<br>
Related specs: [Documentation governance](../../../specs/documentation-governance.md)<br>
Related implementation: `src/main`
