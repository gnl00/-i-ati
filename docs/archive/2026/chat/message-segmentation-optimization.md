...
Reason: Earlier implementation draft with stale code paths<br>
Original path: `docs/chat/message-segmentation-optimization.md`<br>
Replaced by: [Message builder design](../../../chat/message-builder-design.md)
