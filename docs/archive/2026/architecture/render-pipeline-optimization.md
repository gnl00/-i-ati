...
Reason: P0 through P2 implementation completed<br>
Original path: `docs/render-pipeline-optimization.md`<br>
Replaced by: [Streaming main IPC](../../../architecture/streaming-main-ipc.md)
