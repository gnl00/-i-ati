...
> 当前结构请优先参考 [chat-runtime-architecture-current.md](../../../architecture/chat-runtime-architecture-current.md)。
...
- [event-emitter.ts](../../../../src/main/orchestration/chat/run/infrastructure/event-emitter.ts)
- [tool-confirmation.ts](../../../../src/main/orchestration/chat/run/infrastructure/tool-confirmation.ts)
...
- [RunRuntimeFactory.ts](../../../../src/main/orchestration/chat/run/runtime/RunRuntimeFactory.ts)
...
- [RunService.ts](../../../../src/main/orchestration/chat/run/index.ts) 退化成更薄的 facade
- [RunManager.ts](../../../../src/main/orchestration/chat/run/runtime/RunManager.ts) 改成显式依赖注入，不再自己 `new` 一组 runtime 组件
...
- [ChatStepRuntimeContextMapper.ts](../../../../src/main/hosts/chat/mapping/ChatStepRuntimeContextMapper.ts)
...
- [ChatAgentAdapter.ts](../../../../src/main/hosts/chat/ChatAgentAdapter.ts)
- legacy chat-side step wiring 已从主代码移除
- [mapping](../../../../src/main/hosts/chat/mapping/index.ts)
- [persistence](../../../../src/main/hosts/chat/persistence/index.ts)
- [preparation](../../../../src/main/hosts/chat/preparation/index.ts)
- [finalize](../../../../src/main/hosts/chat/finalize/index.ts)
- [config](../../../../src/main/hosts/chat/config/index.ts)

### `chatRun`

当前更接近 shell / runtime orchestration：

- [index.ts](../../../../src/main/orchestration/chat/run/index.ts)
- [runtime/RunManager.ts](../../../../src/main/orchestration/chat/run/runtime/RunManager.ts)
- [runtime/AgentRun.ts](../../../../src/main/orchestration/chat/run/runtime/AgentRun.ts)
- [runtime/RunRuntimeFactory.ts](../../../../src/main/orchestration/chat/run/runtime/RunRuntimeFactory.ts)
- [infrastructure](../../../../src/main/orchestration/chat/run/infrastructure/index.ts)
