...
> 当前结构以 2026-03-26 为准；Telegram transport 迁移细节另见 [telegram-gateway-grammy-migration.md](./telegram-gateway-grammy-migration.md)。
...
- [TelegramGatewayService.ts](../../../../src/main/services/telegram/TelegramGatewayService.ts)
- [TelegramUpdateMapper.ts](../../../../src/main/services/telegram/TelegramUpdateMapper.ts)
- [TelegramAgentAdapter.ts](../../../../src/main/hosts/telegram/TelegramAgentAdapter.ts)
- [telegram-input-text.ts](../../../../src/main/hosts/telegram/telegram-input-text.ts)
- [TelegramFileService.ts](../../../../src/main/services/telegram/TelegramFileService.ts)
...
- [HostChatBindingService.ts](../../../../src/main/hosts/shared/HostChatBindingService.ts)
- [ChatHostBindingRepository.ts](../../../../src/main/db/repositories/ChatHostBindingRepository.ts)
- [ChatHostBindingRepository.ts](../../../../src/main/db/repositories/ChatHostBindingRepository.ts)
...
- [TelegramCommandService.ts](../../../../src/main/services/telegram/TelegramCommandService.ts)
- [telegram-command-parser.ts](../../../../src/main/services/telegram/telegram-command-parser.ts)
...
- `build:mac:ci`
- 使用 [electron-builder.mac-ci.yml](../../../../electron-builder.mac-ci.yml)
- 明确关闭：
  - `hardenedRuntime`
  - `notarize`
  - `gatekeeperAssess`
...
- [ChatHostBindingRepository.ts](../../../../src/main/db/repositories/ChatHostBindingRepository.ts)
- [ChatHostBindingRepository.ts](../../../../src/main/db/repositories/ChatHostBindingRepository.ts)
- [RequestMessageBuilder.ts](../../../../src/shared/services/RequestMessageBuilder.ts)
