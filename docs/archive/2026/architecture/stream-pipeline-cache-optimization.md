...
本次分析发现的问题与 `docs/archive/2026/architecture/render-pipeline-optimization.md`（2026-07-03）有重叠：
...
- [Chat Runtime Architecture](../../../architecture/chat-runtime-architecture-current.md) - 当前架构概览
- [Agent Abstraction](../../../architecture/agent-abstraction.md) - Agent 层抽象设计
